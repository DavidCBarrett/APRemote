...
void gslc_ElemXTextboxPrintf(gslc_tsGui* pGui, gslc_tsElemRef* pElemRef, const char* format, ...){
  char cOut[100];
  va_list args;
...
void gslc_ElemSetTxtPrintf(gslc_tsGui* pGui, gslc_tsElemRef* pElemRef, const char* format, ...){
  char cOut[100];
  va_list args;
