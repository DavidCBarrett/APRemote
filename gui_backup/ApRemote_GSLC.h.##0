...
enum {E_ELEM_BASE_PAGE_LEFT,E_ELEM_BOX4,E_ELEM_BTN35,E_ELEM_BTN36
      ,E_ELEM_BTN_APR_AUTO,E_ELEM_BTN_APR_MINUS_ONE
      ...
      ,E_ELEM_BTN_APR_TRACK,E_ELEM_BTN_APR_WIND
      ,E_ELEM_BTN_BASE_PAGE_RIGHT,E_ELEM_RADIO_APR_AUTO
      ...
      ,E_ELEM_TEXT9,E_ELEM_TEXTBOX4,E_ELEM_TEXTBOX5,E_ELEM_TEXTBOX6
      ,E_ELEM_TEXTBOX7,E_ELEM_TEXTBOX8,E_ELEM_TEXTBOX9
      ,E_ELEM_TEXTBOX_APR_DISPLAY,E_ELEM_TEXTBOX_DIAG_LOG
...
//<InitGUI !Start!>
  ...
  // create E_ELEM_BASE_PAGE_LEFT button with text label
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_BASE_PAGE_LEFT,E_PG_BASE,
    (gslc_tsRect){10,290,40,20},(char*)"Diag",0,E_BUILTIN5X8,&CbBtnCommon);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  
  // create E_ELEM_BTN_BASE_PAGE_RIGHT button with text label
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_BTN_BASE_PAGE_RIGHT,E_PG_BASE,
    (gslc_tsRect){190,290,40,20},(char*)"APR",0,E_BUILTIN5X8,&CbBtnCommon);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  
  // create E_ELEM_BTN35 button with text label
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_BTN35,E_PG_BASE,
    (gslc_tsRect){70,290,40,20},(char*)"Wi-Fi",0,E_BUILTIN5X8,&CbBtnCommon);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  
  // create E_ELEM_BTN36 button with text label
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_BTN36,E_PG_BASE,
  ...
  pElemRef = gslc_ElemCreateBox(&m_gui,GSLC_ID_AUTO,E_PG_DIAG,(gslc_tsRect){10,45,220,235});
  ...
  // Create textbox
  pElemRef = gslc_ElemXTextboxCreate(&m_gui,E_ELEM_TEXTBOX4,E_PG_DATA,&m_sTextbox4,
  ...
  // Create textbox
  pElemRef = gslc_ElemXTextboxCreate(&m_gui,E_ELEM_TEXTBOX5,E_PG_DATA,&m_sTextbox5,
  ...
  // Create textbox
  pElemRef = gslc_ElemXTextboxCreate(&m_gui,E_ELEM_TEXTBOX6,E_PG_DATA,&m_sTextbox6,
  ...
  // Create textbox
  pElemRef = gslc_ElemXTextboxCreate(&m_gui,E_ELEM_TEXTBOX7,E_PG_DATA,&m_sTextbox7,
  ...
  // Create textbox
  pElemRef = gslc_ElemXTextboxCreate(&m_gui,E_ELEM_TEXTBOX8,E_PG_DATA,&m_sTextbox8,
  ...
  // Create textbox
  pElemRef = gslc_ElemXTextboxCreate(&m_gui,E_ELEM_TEXTBOX9,E_PG_DATA,&m_sTextbox9,
